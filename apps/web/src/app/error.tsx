  ...
  return (
    <main className="min-h-screen bg-[var(--color-background)] flex items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-red-500 opacity-[0.03] rounded-full blur-[120px]"></div>
      </div>
      ...
      <div className="max-w-2xl w-full text-center relative z-10">
        <motion.div
          ...
          className="mb-12"
        >
          <div className="w-40 h-40 bg-white rounded-[40px] shadow-3xl border border-red-50 flex items-center justify-center mx-auto relative">
             <span className="material-symbols-outlined text-7xl text-red-500">error</span>
             <div className="absolute -inset-4 border-2 border-red-100 border-dashed rounded-[48px] animate-spin-slow"></div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight">Wystąpił nieoczekiwany błąd</h2>
          <p className="text-xl text-slate-400 max-w-md mx-auto leading-relaxed">
            Nasz system logistyczny napotkał tymczasowy problem. Przepraszamy za utrudnienia.
          </p>
          {error.digest && (
        ...
        >
          <p className="text-[10px] font-bold text-slate-300 uppercase tracking-[0.2em]">
            Status: System Overload • Priority: Emergency Support
          </p>
        </motion.div>
      </div>
    </main>
